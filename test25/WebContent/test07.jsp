...
<%
	...
	// ServletContest application = pageContext.getServletContext();
...
<%
	...
	Exception exception = pageContext.getException();
	out.println("<h2>Exception(예외) : 예외처리 정보를 저장하는 객체</h2>");
	...
	// page.setAttribute("name","장인범");	=> 모든 8대 객체 저장시는 setAttribute("필드명","값") 사용
	// page.setAttribute("name","장인범");	=> 모든 8대 객체에서 값을 가져올 경우는 getAttribute("필드명") 사용
	// 단, request 객체의 값을 가져올 경우는 getParameter("파라미터명")을 사용한다.
%>
<hr>
<div>
	<a href="test08.jsp">scope(스코프) 자세히 알기</a>
</div>
</body>
</html>
